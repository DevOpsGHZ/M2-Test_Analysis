...
First we run our unit test and get a report like this:
...
We then use the following command to generate test cases and calculate coverage.
The coverage get significant improvement.
